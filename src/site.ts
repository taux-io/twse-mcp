...
const ZH: Page = {
  ...
  features: [
    ...
    "單一上市公司的概況：本益比、殖利率、最新月營收年增率、除權息與處置狀態，可附財報摘要與公司治理",
...
const EN: Page = {
  ...
  features: [
    ...
    "Per-company snapshot: P/E, dividend yield, latest monthly revenue growth, ex-dividend and disposition status, plus optional financials and governance",
